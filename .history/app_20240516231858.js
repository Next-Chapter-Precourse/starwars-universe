...
async function displayData(data, category) {
  ...
  for (const item of data) {
    ...
    if (category === "starships") {
      ...
      img.src = "https://cdn.pixabay.com/photo/2015/11/02/14/10/spacecraft-1018225_960_720.jpg";
      img.alt = "Starship Icon";
      img.style.width = "10px"; // Set the width of the image
      img.style.height = "10px"; // Set the height of the image
...
async function showModal(item) {
  ...
  if (item.starships) {
    ...
    item.starships = starships.map(starship => ({
      ...
      picture: 'https://images6.alphacoders.com/306/306546.jpg',
    }));
  }
  // Display the item in a modal
  const modalText = document.getElementById("modalText");"https://cdn.pixabay.com/photo/2015/11/02/14/10/spacecraft-1018225_960_720.jpg"
