...
async function displayData(data, category) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (category === "starships") {
      ...
      img.src = "https://www.istockphoto.com/photo/large-alien-space-ship-in-flight-rear-perspective-view-isolated-3d-rendering-gm1676145076-536259522?utm_source=pixabay&utm_medium=affiliate&utm_campaign=SRP_image_sponsored&utm_content=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fspaceship%2F&utm_term=spaceship";
...
async function showModal(item) {
  ...
  if (item.starships) {
    ...
    item.starships = starships.map(starship => ({
      ...
      picture: 'https://www.istockphoto.com/photo/large-alien-space-ship-in-flight-rear-perspective-view-isolated-3d-rendering-gm1676145076-536259522?utm_source=pixabay&utm_medium=affiliate&utm_campaign=SRP_image_sponsored&utm_content=https%3A%2F%2Fpixabay.com%2Fimages%2Fsearch%2Fspaceship%2F&utm_term=spaceship',
    }));
  }
  ...
  if (item.starships) {
    ...
    picture.src = item.starships[0].picture;
